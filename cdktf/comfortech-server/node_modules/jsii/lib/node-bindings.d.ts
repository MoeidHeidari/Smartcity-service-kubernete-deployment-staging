...
export declare function setRelatedNode<T extends ts.Node = ts.Node>(object: any, node: T): WeakMap<any, ts.Node>;
export declare const setClassRelatedNode: (object: spec.ClassType, node: ts.ClassDeclaration) => spec.ClassType;
export declare const setEnumRelatedNode: (object: spec.EnumType, node: ts.EnumDeclaration) => spec.EnumType;
export declare const setInterfaceRelatedNode: (object: spec.InterfaceType, node: ts.InterfaceDeclaration) => spec.InterfaceType;
export declare const setMethodRelatedNode: <T extends ts.MethodDeclaration | ts.MethodSignature>(object: spec.Method, node: T) => spec.Method;
export declare const setParameterRelatedNode: (object: spec.Parameter, node: ts.ParameterDeclaration) => spec.Parameter;
export declare const setPropertyRelatedNode: (object: spec.Property, node: ts.AccessorDeclaration | ts.ParameterPropertyDeclaration | ts.PropertyDeclaration | ts.PropertySignature) => spec.Parameter;
