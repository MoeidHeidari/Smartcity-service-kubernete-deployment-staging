...
function lookupJsiiSymbol(typeChecker, sym) {
    ...
    if (ts.isSourceFile(decl)) {
        ...
        return (0, util_1.fmap)(sourceAssembly, (asm) => ({
            fqn: (0, util_1.fmap)((0, jsii_1.symbolIdentifier)(typeChecker, sym, (0, util_1.fmap)(sourceAssembly, (sa) => ({ assembly: sa.assembly }))), (symbolId) => sourceAssembly?.symbolIdMap[symbolId]) ?? sourceAssembly?.assembly.name,
            sourceAssembly: asm,
            symbolType: 'module',
        }));
    }
    ...
    const symbolId = (0, jsii_1.symbolIdentifier)(typeChecker, declSym, { assembly: sourceAssembly?.assembly });
    if (!symbolId) {
        return undefined;
    }
